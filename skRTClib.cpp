...
skRTClib RTC = skRTClib() ;             // Preinstantiate Objects
...
/*******************************************************************************
*  ans = begin(Inter,Year,Mon,mDay,wDay,Hour,Min,Sec)                          *
*    ＲＴＣの初期化を行う処理                                                  *
...
*                   5=データ受信エラー                                         *
*******************************************************************************/
int skRTClib::begin(byte Inter,byte Year,byte Mon,byte mDay,byte wDay,byte Hour,byte Min,byte Sec)
{
     int ans ;
     byte reg1 , reg2 ;
